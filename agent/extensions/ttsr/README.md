...
Time Traveling Stream Rules (TTSR) extension. Watches the assistant stream
(text, thinking, tool-call args) for rule violations, aborts
...
- Builtin: `extensions/ttsr/rules/*.md` (27 defaults, lowest priority)
