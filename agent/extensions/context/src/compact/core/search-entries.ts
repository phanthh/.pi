...
import { textOf, isContentBearing, extractToolCallText, extractToolCallArgsText, clip } from "./content.ts";
 ...
 * recall invocation is persisted as an ordinary assistant toolCall (its
 ...
 */
const RECALL_TOOL_NAMES = new Set(["recall", "vcc_recall"]);
 ...
 * k0valik — an upstream derivative.
 */
